...
import com.example.TVK.View.Fragment.ViewPagerAdapterAdmin;
...
public class MainAdminActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewPagerAdapterAdmin adapter= new ViewPagerAdapterAdmin(getSupportFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
