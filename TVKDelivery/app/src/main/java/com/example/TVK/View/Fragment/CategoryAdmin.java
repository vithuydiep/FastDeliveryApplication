...
public class CategoryAdmin extends Fragment {
    ...
    public static CategoryAdmin newInstance(String param1, String param2) {
        CategoryAdmin fragment = new CategoryAdmin();
