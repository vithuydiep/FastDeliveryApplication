...
public class User implements IUser, Serializable {
    ...
    public User(int idUser, String fullName, String gender, String phone, String address, String
        ...
        @Override
        public void checkLogin (String userName_login, String password_login, Context
        context, IViewUltis iViewUltis, IGetAPICallback iGetAPICallback_argument)
        {
        ...
        @Override
        public void getAllDataUser (Context context, IViewUltis iViewUltis, IGetAPICallback
        iGetAPICallback_argument){
            RequestQueue requestQueue = Volley.newRequestQueue(context);
            iGetAPICallback = iGetAPICallback_argument;
        ...
        @Override
        public void changePassword (String new_password, String phone_number, String
        resetPassword, Context context, IViewUltis iViewUltis, IGetAPICallback
        iGetAPICallback_argument){
            RequestQueue requestQueue = Volley.newRequestQueue(context);
            iGetAPICallback = iGetAPICallback_argument;
            StringRequest jsonArrayRequest = new StringRequest(Request.Method.POST, baseUrl + "getdata.php",
